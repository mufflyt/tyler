...
``` r
mysterycall_log_step_complete(success_rate = NULL, n_success = NULL, n_total = NULL)
```
...
`invisible(NULL)` after printing duration and optional success metrics
