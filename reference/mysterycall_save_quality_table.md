...
``` r
mysterycall_save_quality_table(data, filepath)
```
...
The filtered data. A message is emitted indicating where the CSV was
saved.
...
result to CSV. This helper is useful for flagging repeated provider
entries that may require manual review.
