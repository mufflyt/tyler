# Contributing to tyler

Thank you for considering contributing to **tyler**! We welcome bug
reports, feature requests, and pull requests.

## Guidelines

1.  Follow the [rOpenSci contributing
    guide](https://ropensci.org/contributingguide/).
