...
Before using the `mysterycall::get_census_data` function, you need to install and load the required packages. You can do this by running the following code:
...
Call the `get_census_data` function with the `us_fips_list` vector. The helper
