  ...
  for (taxonomy in taxonomy_to_search) {
    ...
    tryCatch({
      ...
      if (!is.null(result)) {
        ...
        cat("Data after creating full_name:\n")
        print(data_taxonomy)
