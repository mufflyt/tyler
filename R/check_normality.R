...
#' )
#'
#' tyler_check_normality(sample_data, "business_days_until_appointment")
#' }
tyler_check_normality <- function(data, variable) {
  # Start logging
...
# tyler_check_normality(df, "business_days_until_appointment")
