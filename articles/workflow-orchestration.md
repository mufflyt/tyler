...
## 11. Business-Day Wait Times

Mystery-caller wait times are measured in **business days** — weekends
and US federal holidays are excluded.
...
#> Business days computed for 6/6 row(s); stored in column 'wait_days'.
...
| NPI   | Insurance | Call date  | Appt date  | Wait (business days) |
|:------|:----------|:-----------|:-----------|---------------------:|
| NPI-1 | Medicaid  | 2024-03-04 | 2024-03-25 |                   15 |
| NPI-2 | Private   | 2024-03-04 | 2024-03-12 |                    6 |
| NPI-3 | Medicaid  | 2024-03-11 | 2024-04-01 |                   15 |
| NPI-4 | Private   | 2024-03-11 | 2024-03-19 |                    6 |
| NPI-5 | Medicare  | 2024-03-18 | 2024-03-27 |                    7 |
| NPI-6 | Uninsured | 2024-03-18 | 2024-04-08 |                   15 |
...
## 12. Caller Quality Control

After data collection is complete, audit each caller’s performance
before proceeding to analysis.

### 12.1 Inter-rater reliability

[`mysterycall_caller_reliability()`](https://mufflyt.github.io/mysterycall/reference/mysterycall_caller_reliability.md)
computes Cohen’s kappa (for categorical outcomes) or the intraclass
correlation coefficient (for numeric outcomes) on records audited by two
callers.
...
#> 95% CI       : [ -0.0087 , 0.7043 ]
#> N pairs      : 30 
#> Interpretation: fair (Landis & Koch)
```

### 12.2 Per-caller productivity

[`mysterycall_call_productivity()`](https://mufflyt.github.io/mysterycall/reference/mysterycall_call_productivity.md)
tallies completed, pending, and failed calls by caller and returns a
...
Table: Per-caller productivity from
[`mysterycall_call_productivity()`](https://mufflyt.github.io/mysterycall/reference/mysterycall_call_productivity.md).
