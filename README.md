...
```r
all_census_data <- tyler::get_census_data(
  us_fips_list,
  vintage = 2019,
  api_key = "your_censusapi_key_here"
)

dplyr::glimpse(all_census_data[, c("geoid", "statefp", "countyfp", "tractce", "block_group", "vintage")])
```

Every row now includes zero-padded 2020 FIPS identifiers for the state, county,
tract, and block group along with the Census vintage used to source the
...
# Reading in NPPES file with dbeaver and postgresql
```
brew update
...
SQL read in of interest.  
```
CREATE TABLE public.npidata_pfile (
	"NPI" integer NULL,
	"Entity Type Code" integer NULL,
	...
	"Provider Other Organization Name Type Code" integer NULL,
	...
	"Provider Other Last Name Type Code" integer NULL,
	"Provider First Line Business Mailing Address" varchar(64) NULL,
	...
	"Provider Business Mailing Address Postal Code" integer NULL,
	"Provider Business Mailing Address Country Code (If outside U.S.)" varchar(50) NULL,
	"Provider Business Mailing Address Telephone Number" integer NULL,
	"Provider Business Mailing Address Fax Number" integer NULL,
	...
	"Provider Business Practice Location Address Postal Code" integer NULL,
	"Provider Business Practice Location Address Country Code (If outside U.S.)" varchar(50) NULL,
	"Provider Business Practice Location Address Telephone Number" integer NULL,
	"Provider Business Practice Location Address Fax Number" integer NULL,
	...
	"Authorized Official Telephone Number" integer NULL,
	...
	"Provider License Number_6" integer NULL,
	...
	"Other Provider Identifier Type Code_1" integer NULL,
	...
	"Other Provider Identifier Type Code_2" integer NULL,
	"Other Provider Identifier State_2" varchar(50) NULL,
	"Other Provider Identifier Issuer_2" varchar(64) NULL,
	"Other Provider Identifier_3" varchar(50) NULL,
	"Other Provider Identifier Type Code_3" integer NULL,
	...
	"Other Provider Identifier Type Code_4" integer NULL,
	...
	"Other Provider Identifier Type Code_5" integer NULL,
	...
	"Other Provider Identifier Type Code_6" integer NULL,
	...
	"Other Provider Identifier Type Code_7" integer NULL,
	"Other Provider Identifier State_7" varchar(50) NULL,
	"Other Provider Identifier Issuer_7" varchar(50) NULL,
	"Other Provider Identifier_8" integer NULL,
	"Other Provider Identifier Type Code_8" integer NULL,
	...
	"Other Provider Identifier Type Code_9" integer NULL,
	...
	"Certification Date" varchar(50) NULL
);
