...
# ---------------------------------------------------------------------------
# 1. Gold standard: known-valid NPIs from tyler::physicians (one at a time)
